...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    TA_SongsListViewController *songsList_VC = [[TA_SongsListViewController alloc] initWithStyle:UITableViewStylePlain];
    UINavigationController *songsList_NavC = [[UINavigationController alloc] initWithRootViewController:songsList_VC];
    
    self.window.rootViewController = songsList_NavC;
